	...
	if name == 'Toggle FlxTrail Options' then
		...
		if valueContents.v1[1] == 'dad' then
			if valueContents.v1[2] == 'colorsync' then
				...
				elseif valueContents.v2[2] == 'off' then
...
function createTrailFrame(tag)
	...
	if daThings.num - trailLength + 1 >= 0 then
		for i = (daThings.num - trailLength + 1), (daThings.num - 1) do
			setProperty('psychicTrail' .. tag .. i .. '.alpha', getProperty('psychicTrail' .. tag .. i .. '.alpha') - ((tag == 'boyfriend' and miss.boyfriend == true) and 2 or (tag == 'gf' and miss.gf == true) or (tag == 'dad' and miss.dad == true) or trailLength * 0.01))
		end
	end
