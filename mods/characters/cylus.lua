...
idle_xml_name = 'Gerbery Idle Dance'
left_xml_name = 'Gerbery Note Left'
down_xml_name = 'Gerbery Note Down'
up_xml_name = 'Gerbery Note Up'
right_xml_name = 'Gerbery Note Right'
...
name_of_character_xml = 'devs/Gerbery'
name_of_character = 'Gerbery'
